function Banner() {
    var keyword = "Programming Communities"; // Changed from "Tuber Boy" to "Programming Communities"
    var canvas;
    var context;
    ...
    var start = function () {
      ...
      bgContext.font = 'bold 150px Arial'; // Adjusted font size and style
      bgContext.fillText(keyword, 50, canvas.height / 2 + 50); // Centered text vertically
